---
title: "01 - Feed-forward Neural Networks"
aliases:
  - "Topic 01 · Feed-forward Neural Networks"
...
> [!quote] References
>
> - Reading: 邱怡轩, 2023 深度学习讲义
> - Reading: Dive into Deep Learning (D2L)
> - Reading: 邱锡鹏, 《神经网络与深度学习》
> - Lecture: 李宏毅, Deep Learning
...
现代的人工神经元结构基本源自 Rosenblatt 的感知机 (Perceptron):
...
#### 2.1.3 Hard-Sigmoid & Hard-Tanh 函数
...
### 2.2 ReLU (Rectified Linear Unit) 激活函数
...
#### 2.2.3 ELU (Exponential Linear Unit)
...
甚至不需要机器参与, 我们可以通过简单的逻辑推理来找到 $w_1,w_2$ 的参数取值, 得到 _AND_ 和 _OR_ 问题的解决方案. 具体而言, 我们希望 INPUT 和 OUTPUT 之间的关系分别为:
...
如果记一个这样的前馈神经网络的层数为 $L$, 第 $l$ 层的神经元个数为 $M_l$, 则其一般的数学表达式为:
...
[[5.Gradient-Descent|一个典型的优化去寻找最小化的过程 (Gradient Descent) 如下]]:
...
### 3.5 FNN 的 PyTorch from Scratch 实现 (以 XOR 问题为例)
