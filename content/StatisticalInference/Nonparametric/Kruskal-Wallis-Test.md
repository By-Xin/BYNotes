...
aliases:
  ...
  - "Kruskal-Wallis Test"
  - "Kruskal-Wallis 检验"
  - "StatisticalInference/Nonparametric.Kruskal-Wallis-Test"
...
Kruskal-Wallis Test is a nonparametric test used to compare the medians of $k\ge 2$ independent population groups. It is a nonparametric alternative to the one-way ANOVA test.

In the Kruskal-Wallis Test:

- There is no normal distribution assumption for the data.
- It still requires the homoscedasticity assumption, i.e. equal variance.
