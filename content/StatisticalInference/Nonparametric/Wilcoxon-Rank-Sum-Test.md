...
aliases:
  ...
  - "Wilcoxon 秩和检验"
  - "StatisticalInference/Nonparametric.Wilcoxon-Rank-Sum-Test"
...
Wilcoxon Rank Sum Test is equivalent to the [Mann-Whitney U Test](./Mann-Whitney-U-Test.md). Both tests compare the medians of two independent populations, do not assume the distribution of the data, and do not require equal sample sizes.
