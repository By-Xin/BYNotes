---
title: "Neyman Factorization Theorem"
aliases:
  - "Neyman_Factorization_Theorem"
  - "Neyman Factorization Theorem"
  - "Neyman 因子分解定理"
  - "StatisticalInference/Sufficiency.Neyman-Factorization-Theorem"
...
This is a product of two functions: one is a function of $S(\mathbf{X})$ only, and the other is a function of $\mathbf{X}$ only. Therefore, by the Neyman Factorization Theorem, $S(\mathbf{X})$ is a sufficient statistic for $p$.

**Example (Sufficient statistic for Poisson distribution).** Consider $X_1, \cdots, X_n \sim_{i.i.d.} \text{Poisson}(\lambda)$. The likelihood function is
...
**Example (Sufficient statistic for normal distribution with $\sigma^2$ known).** Consider $X_1, \cdots, X_n \sim_{i.i.d.} \text{Normal}(\mu, \sigma^2)$ with $\sigma^2$ known. The likelihood function is
...
**Example (Sufficient statistic for normal distribution with $\sigma^2$ unknown).** Consider $X_1, \cdots, X_n \sim_{i.i.d.} \text{Normal}(\mu, \sigma^2)$ with both $\mu$ and $\sigma^2$ unknown. The likelihood function is
...
> [!note] Note: Dimension of sufficient statistics
> In the last case, the sufficient statistic may not be one-dimensional.
