...
> [!theorem] Theorem 3
>
> 存在 $\alpha >0$, 使得对于任意 $\mathbf{0} \in \mathbb{R}^m$, 任意 $\theta \in \mathbb{R}^m$ 且不为零, 以及 $\beta \geq \beta^\star_{\mathcal{H}, \mathcal{P}}$, 有
>
> $$
