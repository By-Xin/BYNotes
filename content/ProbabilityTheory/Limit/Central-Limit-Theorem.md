...
aliases:
  ...
  - "林德伯格-列维定理"
  - "Lindeberg-Levy CLT"
  - "ProbabilityTheory/Limit.Central-Limit-Theorem"
...
- [Generating Binomial Random Variables from Uniforms](../../ComputationalStatistics/Generate-Binomial-from-Uniform.md)
