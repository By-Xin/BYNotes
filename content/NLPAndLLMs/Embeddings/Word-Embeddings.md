...
aliases:
  ...
  - "词嵌入"
  - "Word_Embeddings"
  - "NLPAndLLMs/Embeddings.Word-Embeddings"
...
| 方法类型 | 代表模型 | 核心思想 | 优缺点 |
|----------|----------|----------|--------|
| **Prediction-based** | [Word2Vec](./Word2Vec.md) | 通过预测上下文学习词向量 | 捕捉语义关系, 但无全局信息 |
| **Count-based** | LSA, [GloVe](./GloVe.md) | 基于共现矩阵学习词向量 | 利用全局信息, 但计算复杂 |
...
| Note | Key Concepts |
|------|--------------|
| [Word2Vec](./Word2Vec.md) | Skip-gram, CBOW, neural network perspective, PyTorch implementation |
| [Negative Sampling](./Negative-Sampling.md) | Sampling distribution, binary approximation |
| [GloVe](./GloVe.md) | Co-occurrence matrix, PMI, global vectors |
