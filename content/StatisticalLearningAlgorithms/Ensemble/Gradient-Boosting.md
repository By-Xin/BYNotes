...
aliases:
  - "Gradient_Boosting"
  - "Gradient Boosting"
  - "StatisticalLearningAlgorithms/Ensemble.Gradient-Boosting"
...
Similar to [AdaBoost](./AdaBoost.md), **Gradient Boosting** is an ensemble learning method that adds models to the ensemble so that the new model corrects the errors of its predecessor.
