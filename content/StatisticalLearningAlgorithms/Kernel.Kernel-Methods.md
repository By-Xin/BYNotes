...
更详细的 RKHS 定义和构造见 [RKHS and Representer Theorem](./Kernel.RKHS-and-Representer-Theorem.md).

## Related Notes

- [RKHS and Representer Theorem](./Kernel.RKHS-and-Representer-Theorem.md)
